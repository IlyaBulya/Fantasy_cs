...
class PandascoreApiService
{
    ...
    {
        try {
            $response = $this->client->request('GET', "{$this->baseUrl}/csgo/tournaments/running", [
                'headers' => [
            ...
            \Log::error("Error fetching ongoing tournaments: " . $e->getMessage());
            return [];
        }
    }
    ...
    {
        try {
            $response = $this->client->request('GET', "{$this->baseUrl}/csgo/tournaments/upcoming", [
                'headers' => [
                    'Authorization' => "Bearer {$this->apiKey}",
                    'Accept' => 'application/json',
                ],
            ...
            \Log::error("Error fetching upcoming tournaments: " . $e->getMessage());
            return [];
        }
    }
