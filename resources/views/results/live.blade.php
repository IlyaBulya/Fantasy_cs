        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-2xl font-bold text-yellow-400 mb-6">Live Match Results (CS:GO)</h1>
                                ...
                                <div class="bg-gray-800 text-white p-4 rounded-lg">
                                    ...
                                    <div class="mt-4 flex justify-center space-x-4">
                                        @if(!empty($match['streams_list']))
                                            <a href="{{ $match['streams_list'][0]['raw_url'] }}" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                                Watch Stream
                                            </a>
                                        @else
                                            <span class="text-gray-400">No stream available</span>
                                        @endif
